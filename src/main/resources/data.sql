insert into magazine_project.public.magazines(active, price, title, image_path)
...
insert into magazine_project.public.users(user_name, email, password, role)
...
update magazine_project.public.magazines
